...
#define MLX_WINSHOW_DURATION	400
#define MLX_ANISWITCH_DURATION	200
...
#define ID_HOMELIST			20
#define ID_HOMELIST_FM		200
#define ID_HOMELIST_DM		201
#define ID_HOMELIST_EVT		202
#define ID_HOMELIST_SH		203
#define ID_HOMELIST_RB		204
#define ID_HOMELIST_SHD		205
#define ID_HOMELIST_BYE		206
#define ID_SETTLIST			30
#define ID_FILELIST			40

extern LIBAROMA_CONTROLP appbar, fragctl, sidelist, filelist, settlist, homelist, busyprog, kbfctl;
extern LIBAROMA_WINDOWP winmain, sidebar, homefrag, settfrag, filemfrag, filesfrag, busyfrag, kbfrag;
...
extern void homelist_onclick(LIBAROMA_CONTROLP list);
...
#define aromafm_statusbar_reset() aromafm_statusbar_update("Lumia Test")
#define aromafm_bar_reset() libaroma_ctl_bar_set_tools(appbar, NULL, 0); \
							aromafm_bar_update("LumiaTest", NULL, LIBAROMA_CTL_BAR_ICON_ARROW_TO_DRAWER)

/* functions */
extern AROMAFMP aromafm();
extern FM_NAVBARP navbar();
extern byte mlx_home_init(word bgcolor);
extern byte mlx_settings_init(word bgcolor);
